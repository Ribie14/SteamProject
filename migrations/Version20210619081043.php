...
final class Version20210619081043 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE games (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(255) NOT NULL, createur VARCHAR(255) NOT NULL, description VARCHAR(500) NOT NULL, prix INT NOT NULL, date DATE NULL, téléchargement INT NOT NULL, image VARCHAR(1000) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
